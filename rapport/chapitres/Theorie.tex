...
\end{equation}
À l'instant du lâcher, l'actionneur est immobile à la position extrême : \(\alpha(0) = \Delta\alpha_{\max}\) et \(\Omega(0) = 0\). De plus, \eqref{eq:meca_libre_omega1} évaluée en \(t=0\) donne \(\dot\Omega(0) = -K_r\,\Delta\alpha_{\max}/J = -\omega_n^2\,\Delta\alpha_{\max}\). Les conditions \(\Omega(0)=0\) et \(\dot\Omega(0) = -\omega_n^2\,\Delta\alpha_{\max}\) imposent \(C_1 = 0\) et \(C_2 = -\omega_n^2\,\Delta\alpha_{\max}/\omega_0\), d'où :
\begin{equation}
...
\]
La validité de cette simplification sera contrôlée \emph{a posteriori} par le ratio \(\omega_n/\delta\).
